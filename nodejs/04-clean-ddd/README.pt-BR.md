...
🗂️ Aplicação estilo fórum.
Esta aplicação foi desenvolvida como parte do Projeto 04 do módulo "Nível 04 DDD e Primeiro Framework > DDD no Node.js" do Bootcamp Ignite Node.js na Rocketseat.
...
# Instalar vite-tsconfig-paths
npm i vite-tsconfig-paths -D

# Instalar ESLint
npm i eslint @rocketseat/eslint-config -D

# Instalar faker-js para lidar com dados fictícios
